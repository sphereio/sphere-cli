  ...
  describe Projects do
    ...
    describe '#create' do
      ...
      it 'just works' do
        ...
        Excon.stub(
          { :method => :post, :path => '/api/projects', :body => '{"name":"p","key":"p","owner":{"typeId":"organization","id":"org"},"languages":["de","en"],"currencies":["YEN"]}' },
          { :status => 200, :body => '{"project":{"key":"p"},"client":{"id":"123","secret":"geheim"}}' })
        Excon.stub(
